...
class Fire_Outbreak_Screen extends StatefulWidget {
  const Fire_Outbreak_Screen({Key? key}) : super(key: key);

  @override
  State<Fire_Outbreak_Screen> createState() => _Fire_Outbreak_ScreenState();
}

class _Fire_Outbreak_ScreenState extends State<Fire_Outbreak_Screen> {
  bool isCheck = false;
  late File imageFile;
  ...
  Future submitReport(Report report) async {
    final docReport = FirebaseFirestore.instance.collection('fireReport').doc();
